...
\n\x1b[1;33mAUTHOR:EXPERT
\n\x1b[1;33mMY TELEGRAM @i4m_EXPERT
\n\x1b[1;33mMY CHANALE:HTS_EXPERT
CRACKED~BY~HTS

\033[33mtkaya gar edit dakayt ba nawman la gal bet
\033[33mgar edit dakayt ba pyawana bika w maifrosha
"""
print("___________r_rezhear_________________")
back = 0
successful = []
cpb = []
oks = []
